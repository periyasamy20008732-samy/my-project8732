...
{
    /**
     * Display the customer list page and handle DataTables AJAX request.
     */
                ...
                ->addColumn('action', function ($row) {
                    return '
                        <div class="edit-delete-action d-flex">
                            ...
                            <button type="button" class="btn edit-btn" data-id="' . $row->id . '" style="border: none; background: transparent; padding: 0; margin-right: 5px;">
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.customer', compact('countries'));
    }

                        ...
                        <div class="add-item d-flex">
                            ...
                            <div class="page-btn">
                                <a href="#" class="btn btn-added" data-bs-toggle="modal"
                                    data-bs-target="#add-payroll-new"><i data-feather="plus-circle" class="me-2"></i>
                                    Add New Sales</a>
                            </div>
                        </div>
                        <ul class="table-top-head">
                            <li>
                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><i data-feather="edit"
                                        class="action-edit sales-action"></i></a>
                            </li>
                            <li>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            $.get(`/store/sales/${id}`, function (data) {
                $('#edit_id').val(data.id);

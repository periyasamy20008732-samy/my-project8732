							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="{{ route('admin.sales-dashboard') }}" >Sales Dashboard</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a href="javascript:void(0);"><i data-feather="smartphone"></i><span>Sales</span><span class="menu-arrow"></span></a>
									<ul>
										<li><a href="chat.html">New Sale</a></li>
										<li><a href="calendar.html">Sale List</a></li>
										<li><a href="email.html">Sales Return</a></li>
										<li><a href="todo.html">Purchase Order</a></li>
										
									</ul>
								</li>
									<li class="submenu">
									 <a href="javascript:void(0);"><i data-feather="smartphone"></i><span>Contacts</span><span class="menu-arrow"></span></a>
									 <ul>
										<li><a href="chat.html">Add Customer</a></li>
										<li><a href="{{ route('admin.customer') }}" >Customer List<span></span></a></li>
										<li><a href="calendar.html">Add Supplier</a></li>
										<li><a href="email.html">Supplier List</a></li>
									   </ul>
								     </li>

									 <li class="submenu">
									 <a href="javascript:void(0);"><i data-feather="smartphone"></i><span>Purchase</span><span class="menu-arrow"></span></a>
									 <ul>
										<li><a href="chat.html">New Purchase</a></li>
										<li><a href="">Purchase List<span></span></a></li>
										<li><a href="calendar.html">Purchase Return List</a></li>
									   </ul>
								     </li>
									 <li class="submenu">

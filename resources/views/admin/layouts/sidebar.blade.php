						...
						<li class="submenu-open">
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										<li><a  href="{{ route('admin.dashboard') }}" class="active" style="color:black">Admin Dashboard</a></li>
										
									</ul>
								</li>
								 <li class="submenu">
									 <a href="javascript:void(0);"><i data-feather="user"></i><span>Customer</span><span class="menu-arrow"></span></a>
									 <ul>
										<li><a href="{{ route('admin.customer') }}" style="color:black">customer Settings</a></li>
									   </ul>
								     </li>
									<li class="submenu">
									 <a href="javascript:void(0);"><i data-feather="smartphone"></i><span>Package</span><span class="menu-arrow"></span></a>
									 <ul>
										<li><a href="{{ route('admin.package') }}" style="color:black">Package Settings</a></li>
										
									   </ul>
								     </li>

									  <li class="submenu"> 
									<a href="javascript:void(0);"><i data-feather="settings"></i><span>Core settings</span><span class="menu-arrow"></span></a>
									<ul>
										
										<li><a href="{{ route('admin.tax') }}" style="color:black">Tax Settings</a></li>
										<li><a href="{{ route(name: 'admin.unit') }}" style="color:black">Unit Settings</a></li>
										<li><a href="{{ route('admin.country') }}" style="color:black">Country Settings</a></li>

...
<div class="page-wrapper">
                    ...
                    <table class="table datanew">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-linesuccess">{{ $customers->status }}</span>
                                </td>
    ...
    <div class="edit-delete-action d-flex">
        <!-- Edit Button -->
        <a href="#" data-bs-toggle="modal" data-bs-target="#editModal{{ $customers->id }}" class="me-2">
            <img src="{{ asset('admin-assets/img/icons/edit.svg') }}" alt="Edit">
        </a>

        <!-- Delete Button with SweetAlert -->
        <form id="delete-form-{{ $customers->id }}" action="{{ route('admin.customers.destroy', $customers->id) }}" method="POST" style="display: inline;">
            @csrf
            @method('DELETE')
            <button type="button" class="delete-btn" data-id="{{ $customers->id }}" style="border: none; background: transparent; padding: 0;">
                <img src="{{ asset('admin-assets/img/icons/delete.svg') }}" alt="Delete">
                            ...
                            <div class="modal fade" id="editModal{{ $customers->id }}">
                                        ...
                                        <div class="page-wrapper-new p-0">
                                            <div class="content">
                                                ...
                                                <div class="modal-body custom-modal-body">
                                                    <form method="POST" action="{{ route('admin.package.update', $customers->id) }}">
                                                        @csrf
                                                        @method('PUT')
									...
									<div class="row">
										<div class="col-lg-4 pe-0">
											<div class="mb-3">
												...
												<input type="text" class="form-control" value="{{ $customers->customer_name }}">
											</div>
										</div>
										<div class="col-lg-4 pe-0">
											<div class="mb-3">

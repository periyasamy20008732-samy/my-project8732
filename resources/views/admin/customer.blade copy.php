                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        ...
                                        <a class="me-2 p-2" href="{{ route('admin.customers.edit', $customers->id) }}"
...
<tr>
    ...
    <td>
        ...
        <button type="button" class="btn btn-link p-2" data-bs-toggle="modal"
            data-bs-target="#editModal{{ $customers->id }}">
            <i data-feather="edit" class="feather-edit"></i>
        </button>

        <!-- Edit Modal (inside the loop so it's unique per user) -->
        <div class="modal fade" id="editModal{{ $customers->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered custom-modal-two">
                <div class="modal-content">
                    <div class="page-wrapper-new p-0">
                        <div class="content">
                            ...
                            <div class="modal-body custom-modal-body">
                                <form action="{{ route('admin.customers.update', $customers->id) }}" method="POST"
                                    ...
                                    <div class="new-employee-field">
                                        <div class="profile-pic-upload">
                                            <div class="profile-pic people-profile-pic">
                                                <img src="{{ asset('storage/'.$customers->avatar) }}" alt="Img"
                                                    onerror="this.src='{{ asset('assets/img/profiles/profile.png') }}'">
                                            </div>
                                            <div class="mb-3">
                                                <div class="image-upload mb-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 pe-0">
                                            <div class="mb-3">
                                                ...
                                                <select class="select form-select" name="city">
                                                    <option selected>{{ $customers->city }}</option>
                                        ...
                                        <div class="col-lg-6 pe-0">
                                            <div class="mb-3">
                                                <label class="form-label">Country</label>
                                                <select class="select form-select" name="country">
                                                    <option selected>{{ $customers->country->name ?? 'N/A' }}</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-0 input-blocks">
                                                ...
                                                <textarea class="form-control mb-1"
                                                    name="description">{{ $customers->description }}</textarea>
                                                <p>Maximum 60 Characters</p>
                                            </div>
                                        </div>
                                    </div>
